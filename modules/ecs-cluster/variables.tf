variable "autoscaling_group_name" {
  description = "Name of AWS Auto Scaling Group that are part of the ECS Cluster"
  type        = string
}
...
variable "metric" {
  ...
  type        = object({
    name           = optional(string, "MemoryReservation") # Available built-in metrics: https://docs.aws.amazon.com/AmazonECS/latest/developerguide/cloudwatch-metrics.html#ecs-metrics
